...
<div class="code">
	...
	#--------------------------------------
		...
		<form  method='post' action='metodos/basico.php'>    
		...
		<div>
			...
			elseif(isset($_POST['activacion'])){
				...
				<form method='post' action='metodos/activacion.php'> 
				...
				<div>
					...
					elseif(isset($_POST['similitud'])){
						echo "
						<form method='post' action='metodos/similitud.php'>
						...
						<div>
							...
							elseif(isset($_POST['identacion'])){
								echo "
								<form method='post' action='metodos/identacion.php'>    
								...
								<div>
									...
									elseif(isset($_POST['sophia'])){
										echo "
										<form method='post' action='metodos/sophia.php'>
